...
issue](https://github.com/cisagov/ansible-role-logrotate/issues) in
...
request](https://github.com/cisagov/ansible-role-logrotate/pulls), you
...
pyenv virtualenv <python_version_to_use> ansible-role-logrotate
pyenv local ansible-role-logrotate
